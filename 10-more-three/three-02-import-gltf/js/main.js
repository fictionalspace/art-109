...
function animate() {
    ...
    ball.position.y = Math.sin(Date.now() / 4000) * 3;
    ...
    if (dog) {
        ...
        dog.rotation.y += 0.007;
            //dog.position.x = Math.sin(Date.now() / 3000) * 2;
            dog.position.y = Math.sin(Date.now() / 4000) * 3;
            //dog.position.z = Math.sin(Date.now() / 5000) * 4;
    }
